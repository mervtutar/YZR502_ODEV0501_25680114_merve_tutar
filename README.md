...
| Dosya | Açıklama |
|-------|----------|
| `sekil1_yorunge_karsilastirma.png` | Gerçek yörünge vs. Odometri vs. GPS vs. EKF |
| `sekil2_hata_karsilastirma.png` | Zamana bağlı lokalizasyon hatası |
| `sekil3_ekf_belirsizlik.png` | EKF kovaryans (belirsizlik) analizi |
| `sekil4_xy_hata_bilesenleri.png` | X ve Y eksenlerinde hata bileşenleri |
| `sekil5_rmse_karsilastirma.png` | RMSE bar grafiği karşılaştırması |
